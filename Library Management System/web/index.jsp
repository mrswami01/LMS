<%-- 
    Document   : index
    Created on : 30 Nov, 2022, 6:46:32 PM
    Author     : Mandy
--%>
    ...
    <body class="index_body">
        <div class="topbar">
            <div class="Homepage_header">
                <img width="74" height="75" src="img/VJTI_logo.png" class="custom-logo" alt="VJTI Mumbai" decoding="async" srcset="https://xkt381.n3cdn1.secureserver.net/wp-content/uploads/oldupload/cropped-New-VJTI-Logo_1-1-52x75.jpg 52w, https://xkt381.n3cdn1.secureserver.net/wp-content/uploads/oldupload/cropped-New-VJTI-Logo_1-1-208x300.jpg 208w, https://xkt381.n3cdn1.secureserver.net/wp-content/uploads/oldupload/cropped-New-VJTI-Logo_1-1.jpg 400w" sizes="(max-width: 52px) 100vw, 52px" style="margin:0px">
                <p class="title" id="vjti">
                    VJTI Mumbai<br>
        ...
        <script>
            function myFunction() {
                ...
                var change = document.getElementById("vjti");
