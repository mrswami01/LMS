...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body>
       ...
       <script>
        ...
        if(msg === 'Category Updated'){
            alert ("Category Updated");
        }    
        if(delmsg === 'Category Deleted'){
            alert ("Category Deleted");
        }
        if(msg === 'Added Category'){
                                            ...
                                            <c:forEach var = "row" items = "${result.rows}">                                       
                                                <tr class="odd gradeX">
                                                    ...
                                                    <td class="center">
                                                        ...
                                                        <td class="center">
                                                            <a href="edit-category.jsp?catid=${row.CatId}"><button class="btn btn-primary"><i class="fa fa-edit "></i> Edit</button> 
                                                                <a href="DB_Changes/delete_category.jsp?del=${row.CatId}" onclick="return confirm('Are you sure you want to delete?');" >  <button class="btn btn-danger"><i class="fa fa-pencil"></i> Delete</button>
                                                                    </td>
                                                                    </tr>
                                                                    <% cnt=cnt+1; %>
                                                                </c:forEach>                                    
